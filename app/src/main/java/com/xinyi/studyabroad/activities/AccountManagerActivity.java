...
public class AccountManagerActivity extends BaseActivity {
    ...
    protected void initViews() {
        super.initViews();
        hideRightTv();
        initTitle(R.string.payManagerString);
    ...
    protected void initDatas() {
        ...
        OkGo.<String>post(AppUrls.CustomerMy_walletUrl)
                ...
                .params(DoParams.encryptionparams(AccountManagerActivity.this, params, user_token))
                .tag(this)
                .execute(new DialogCallBack((Activity) AccountManagerActivity.this, true) {
                    @Override
                    ...
                    public void onError(com.lzy.okgo.model.Response<String> response) {
                        ...
                        HandleResponse.handleException(response, AccountManagerActivity.this);
                    }
                });
    }
}
